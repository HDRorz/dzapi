...
class table_common_member_archive extends table_common_member
{
	...
	public function move_to_master($uid){
		if(isset($this->membersplit) && ($uid = intval($uid)) && ($member = $this->fetch($uid))) {
			...
			S::t('common_member_count')->insert(S::t('common_member_count_archive')->fetch($uid));
			S::t('common_member_status')->insert(S::t('common_member_status_archive')->fetch($uid));
			S::t('common_member_profile')->insert(S::t('common_member_profile_archive')->fetch($uid));
			S::t('common_member_field_home')->insert(S::t('common_member_field_home_archive')->fetch($uid));
			S::t('common_member_field_forum')->insert(S::t('common_member_field_forum_archive')->fetch($uid));
			$this->delete($uid);
			S::t('common_member_count_archive')->delete($uid);
			S::t('common_member_status_archive')->delete($uid);
			S::t('common_member_profile_archive')->delete($uid);
			S::t('common_member_field_home_archive')->delete($uid);
			S::t('common_member_field_forum_archive')->delete($uid);
		}
	}
